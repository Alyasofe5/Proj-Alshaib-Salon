...
// For super_admin, allow specifying salon_id
...
if ($method === 'POST') {
    ...
    if (!in_array($file['type'], $allowedTypes)) {
        sendError('نوع الملف غير مدعوم. المسموح: JPG, PNG, WebP, GIF');
    }
    ...
    // Create uploads directory (use document root for public access)
