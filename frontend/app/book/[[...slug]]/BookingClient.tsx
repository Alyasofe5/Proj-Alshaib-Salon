...
function BookingContent({ params }: { params: { slug: string } }) {
    ...
    const mockFaqs = salon.faqs?.length ? salon.faqs : [
        { id: 1, question: "هل يتوفر مواقف سيارات؟||Is there parking available?", answer: "نعم، نوفر مواقف مجانية لعملائنا أمام الصالون مباشرة.||Yes, we provide free parking for our customers directly in front of the salon." },
        { id: 2, question: "هل يمكن إلغاء أو تعديل الموعد؟||Can I cancel or reschedule my appointment?", answer: "بالطبع، تواصل معنا قبل ساعتين على الأقل من موعدك.||Of course, please contact us at least two hours before your appointment." },
        { id: 3, question: "ما هي طرق الدفع المتاحة؟||What payment methods are available?", answer: "نوفر الدفع نقداً وعبر البطاقات الائتمانية وبطاقات مدى.||We accept cash, credit cards, and Mada cards." },
    ];
                    ...
                    <div className="relative z-20 w-full max-w-[1500px] mx-auto grid grid-cols-1 lg:grid-cols-2 px-6 sm:px-12 lg:px-16 pt-[20vh] lg:pt-0 pb-20 my-auto">
                        ...
                        <div className={`flex flex-col justify-end lg:justify-center w-full ${lang === 'en' ? 'text-left lg:pr-12 xl:pr-20' : 'text-right lg:pl-12 xl:pl-20'}`}>
                            ...
                            >
                                ...
                                >
                                    <span className="btn-content">
                                        <span className="btn-label">{lang === 'ar' ? "احجز موعدك الآن" : "Book Your Visit"}</span>
                                        <span className="btn-icon-wrapper" aria-hidden="true">
                                            {lang === 'ar' ? (
                                                <>
