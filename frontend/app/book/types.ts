export interface Service { id: number; name: string; name_en?: string | null; price: string; duration_minutes: number | null; image: string | null; video?: string | null; }
export interface Employee { id: number; name: string; name_en?: string | null; avatar?: string; role?: string; specialty?: string; }
export interface SalonInfo {
    name: string; name_en?: string | null; slug: string; logo: string | null; logo_path?: string | null; phone: string | null;
