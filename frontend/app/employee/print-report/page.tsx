            ...
            <div className="no-print topbar" style={{ gap: "12px", flexWrap: "wrap" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                    <Link href="/employee/dashboard"
                        style={{ display: "flex", alignItems: "center", gap: "6px", color: "var(--gold)", textDecoration: "none", fontSize: "13px", fontWeight: 600 }}>
                        <ArrowRight size={14} /> العودة
                    </Link>
                    <div className="topbar-title">
                        <FileText size={16} className="inline ml-2 text-gold" />
                ...
                <div style={{ display: "flex", gap: "8px", alignItems: "center", flexWrap: "wrap", marginRight: "auto" }}>
                    ...
                    {period === "daily" ? (
                        <input type="date" value={date} onChange={(e) => setDate(e.target.value)}
                            style={{ background: "var(--dark4)", border: "1px solid var(--gold)", color: "#fff", padding: "7px 12px", borderRadius: "8px", fontFamily: "Tajawal", fontSize: "13px" }} />
                    ) : (
