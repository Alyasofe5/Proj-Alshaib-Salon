                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="mb-20">
                        ...
                        <h1 className="text-white text-4xl sm:text-6xl lg:text-7xl font-black tracking-tighter mb-8" style={{ fontFamily: salon ? "var(--font-el-messiri), sans-serif" : "inherit" }}>
                            سياسة <span className="text-[#C3D809]" style={{ fontStyle: "italic", fontWeight: 700 }}>الخصوصية</span>
                        </h1>
                        <p className="text-white/40 leading-relaxed max-w-2xl">توضح هذه الصفحة كيفية جمع واستخدام وحماية بياناتك الشخصية عند استخدام خدمات {salonName} وحجز المواعيد عبر موقعنا.</p>
                    </div>
