                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="space-y-16 lg:space-y-24">
                        <section className="space-y-6">
                            <h2 className="text-2xl font-bold text-white border-b border-white/5 pb-4">١. سياسة الحجز</h2>
                            <p className="text-white/60 leading-[1.8]">يتم تأكيد المواعيد بناءً على التوفر. نطلب الحجز المسبق لضمان حصولك على الخدمة في الوقت المناسب. يتم حجز الموعد باسمك ورقم هاتفك.</p>
                        </section>

                        <section className="space-y-6">
                            <h2 className="text-2xl font-bold text-white border-b border-white/5 pb-4">٢. الإلغاء والتأخير</h2>
                            <p className="text-white/60 leading-[1.8]">في حال رغبتك في إلغاء أو تعديل الموعد، يرجى إبلاغنا قبل ساعتين على الأقل. في حالة التأخر لأكثر من ١٥ دقيقة، قد نضطر إلى تقديم الخدمة بمقدار الوقت المتبقي أو إعادة جدولة الموعد.</p>
                        </section>

                        <section className="space-y-6">
                            <h2 className="text-2xl font-bold text-white border-b border-white/5 pb-4">٣. المسؤولية</h2>
                            <p className="text-white/60 leading-[1.8]">نحن نلتزم بتقديم أعلى مستويات الجودة والأمان، ولكننا نطلب من العملاء الإفصاح عن أي حساسية أو حالات طبية تتعلق بتلقي الخدمات داخل الصالون.</p>
                        </section>

                        <section className="space-y-6">
                            <h2 className="text-2xl font-bold text-white border-b border-white/5 pb-4">٤. طرق الدفع</h2>
                            <p className="text-white/60 leading-[1.8]">نقبل الدفع نقداً وكافة أنواع البطاقات الائتمانية وبطاقات مدى. يتم تسوية كافة الرسوم في الصالون بعد الانتهاء من الخدمة مباشرة.</p>
                        </section>
                    </div>
                </div>
            </main>
